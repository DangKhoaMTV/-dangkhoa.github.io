...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'setLfmPath']], function () {
  ...
  Route::group(['middleware' => 'checkpermission:Content Management'], function () {
        ...
        Route::get('/herosection/slider/{id}/edit_modal', 'Admin\SliderController@edit_modal')->name('admin.slider.edit-modal');
        ...
        Route::get('/feature/{id}/edit_modal', 'Admin\FeatureController@edit_modal')->name('admin.feature.edit-modal');
        ...
        Route::get('/approach/{id}/pointedit_modal', 'Admin\ApproachController@pointedit_modal')->name('admin.approach.point.edit-modal');
        ...
        Route::get('/statistics/{id}/edit_modal', 'Admin\StatisticsController@edit_modal')->name('admin.statistics.edit-modal');
        ...
        //Admin Special Offer
          Route::get('/special_offers', 'Admin\SpecialOfferController@index')->name('admin.special_offer.index');
          Route::post('/special_offer/store', 'Admin\SpecialOfferController@store')->name('admin.special_offer.store');
          Route::get('/special_offer/{id}/edit', 'Admin\SpecialOfferController@edit')->name('admin.special_offer.edit');
          Route::post('/special_offer/update', 'Admin\SpecialOfferController@update')->name('admin.special_offer.update');
          Route::post('/special_offer/delete', 'Admin\SpecialOfferController@delete')->name('admin.special_offer.delete');
          Route::post('/special_offer/bulk-delete', 'Admin\SpecialOfferController@bulkDelete')->name('admin.special_offer.bulk.delete');
          Route::post('/special_offer/feature', 'Admin\SpecialOfferController@feature')->name('admin.special_offer.feature');
        ...
        Route::get('/testimonial/{id}/edit_modal', 'Admin\TestimonialController@edit_modal')->name('admin.testimonial.edit-modal');
        ...
        Route::get('/partner/{id}/edit_modal', 'Admin\PartnerController@edit_modal')->name('admin.partner.edit-modal');
        ...
        Route::get('/member/{id}/edit_modal', 'Admin\MemberController@edit_modal')->name('admin.member.edit-modal');
        ...
        Route::get('/scategory/{id}/edit_modal', 'Admin\ScategoryController@edit_modal')->name('admin.scategory.edit-modal');
        ...
        Route::get('/service/{id}/edit_modal', 'Admin\ServiceController@edit_modal')->name('admin.service.edit-modal');
      Route::get('/service/{id}/images', 'Admin\ServiceController@images')->name('admin.service.images');
      ...
      Route::get('/service/attribute', 'Admin\ServiceController@attribute')->name('admin.service.attribute');

      Route::post('/service/attribute_store', 'Admin\ServiceController@attribute_store')->name('admin.service.attribute_store');
      Route::get('/service/{id}/attribute_edit', 'Admin\ServiceController@attribute_edit')->name('admin.service.attribute_edit');
      Route::post('/service/attribute_update', 'Admin\ServiceController@attribute_update')->name('admin.service.attribute_update');
      Route::post('/service/attribute_delete', 'Admin\ServiceController@attribute_delete')->name('admin.service.attribute_delete');

        // Admin Dinning Routes
        Route::get('/dinning/settings', 'Admin\DinningController@settings')->name('admin.dinning.settings');
        Route::post('/dinning/settings/updateSettings', 'Admin\DinningController@updateSettings')->name('admin.dinning.updateSettings');
        Route::get('/dinnings', 'Admin\DinningController@index')->name('admin.dinning.index');
        Route::post('/dinning/store', 'Admin\DinningController@store')->name('admin.dinning.store');
        Route::get('/dinning/{id}/edit', 'Admin\DinningController@edit')->name('admin.dinning.edit');
        Route::post('/dinning/update', 'Admin\DinningController@update')->name('admin.dinning.update');
        Route::post('/dinning/delete', 'Admin\DinningController@delete')->name('admin.dinning.delete');
        Route::post('/dinning/bulk-delete', 'Admin\DinningController@bulkDelete')->name('admin.dinning.bulk.delete');
        Route::post('/dinning/feature', 'Admin\DinningController@feature')->name('admin.dinning.feature');
      Route::get('/dinning/{id}/images', 'Admin\DinningController@images')->name('admin.dinning.images');
      Route::get('/dinning/{id}/images_box', 'Admin\DinningController@images_box')->name('admin.dinning.images_box');
        ...
        Route::get('/portfolio/{id}/edit_modal', 'Admin\PortfolioController@edit_modal')->name('admin.portfolio.edit-modal');
        ...
        Route::get('/bcategory/{id}/edit', 'Admin\BcategoryController@edit')->name('admin.bcategory.edit');
        ...
        Route::get('/blog/{id}/edit_modal', 'Admin\BlogController@edit_modal')->name('admin.blog.edit-modal');
        ...
        Route::get('/gallery/{id}/edit_category_modal', 'Admin\GalleryCategoryController@edit_modal')->name('admin.gallery.edit_category_modal');
        ...
        Route::get('/gallery/{id}/edit_modal', 'Admin\GalleryController@edit_modal')->name('admin.gallery.edit_modal');
      ...
      Route::get('/faq/{id}/edit_category', 'Admin\FAQCategoryController@edit')->name('admin.faq.edit_category');
    ...
    Route::group(['middleware' => 'checkpermission:Shop Management'], function () {
        ...
        Route::get('/product/attribute', 'Admin\ProductController@attribute')->name('admin.product.attribute');

        Route::post('/product/attribute_store', 'Admin\ProductController@attribute_store')->name('admin.product.attribute_store');
        Route::get('/product/{id}/attribute_edit', 'Admin\ProductController@attribute_edit')->name('admin.product.attribute_edit');
        Route::post('/product/attribute_update', 'Admin\ProductController@attribute_update')->name('admin.product.attribute_update');
        Route::post('/product/attribute_delete', 'Admin\ProductController@attribute_delete')->name('admin.product.attribute_delete');
        ...
        Route::get('/product/create_modal', 'Admin\ProductController@create_modal')->name('admin.product.create_modal');
        ...
        Route::get('/product/{id}/edit_modal', 'Admin\ProductController@edit_modal')->name('admin.product.edit_modal');
    ...
    Route::group(['middleware' => 'checkpermission:Events Management'], function () {
        ...
        Route::get('/event/category/{id}/edit', 'Admin\EventCategoryController@edit')->name('admin.event.category.edit');
        ...
        Route::get('/event/{id}/edit_modal', 'Admin\EventController@edit_modal')->name('admin.event.edit_modal');
    ...
    Route::group(['middleware' => 'checkpermission:Event Calendar'], function () {
        ...
        Route::get('/calendars/{id}/edit', 'Admin\CalendarController@edit')->name('admin.calendar.edit');
    ...
    Route::group(['middleware' => 'checkpermission:Course Management'], function () {
        ...
        Route::get('/course_category/{id}/edit', 'Admin\CourseCategoryController@edit')->name('admin.course_category.edit');
    ...
    Route::group(['middleware' => 'checkpermission:Package Management'], function () {
        ...
        Route::get('/package/{id}/edit_category', 'Admin\PackageCategoryController@edit')->name('admin.package.edit_category');
        ...
        Route::get('/package/{id}/preview_modal', 'Admin\PackageController@preview_modal')->name('admin.package.preview_modal');
...
Route::localized(function () {
    ...
    Route::group(['middleware' => ['setlang']], function () {
        ...
        $lang_id = $lang->id;
      $wdPermalinks = Permalink::where('language_id',$lang_id)->where('details', 1)->get();
      foreach ($wdPermalinks as $pl) {
        ...
        } elseif ($type == 'dinning_details') {
          Route::get("$permalink/{slug}", 'Front\FrontendController@dinning_menu')->name('front.dinning_menu');
    ...
    Route::group(['middleware' => ['setlang']], function () {
        $locale =  app()->getLocale();
        $lang_id = Language::where('code',$locale)->first()->id;
        $wdPermalinks = Permalink::where('language_id',$lang_id)->where('details', 0)->get();
      foreach ($wdPermalinks as $pl) {
        $type = $pl->type;
        $permalink = $pl->permalink;
          $language_id = $pl->language_id;
          $lang_code = Language::findOrFail($language_id)->code;
        ...
        if ($type == 'packages') {
          ...
          $action = 'Front\FrontendController@dinning';
          $routeName = 'front.dinning';
        } elseif ($type == 'special_offers') {
          $action = 'Front\FrontendController@special_offers';
          $routeName = 'front.special_offers';
    ...
    // Dynamic Page Routes
    Route::group(['middleware' => 'setlang'], function () {
        Route::get('/create_thumb', 'Front\FrontendController@create_thumb')->name('front.create_thumb');
