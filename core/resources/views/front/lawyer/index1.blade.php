                                ...
                                <div class="lawyer_img">
                                    @if (!empty($service->main_image))
                                        <div class="logistics_icon">
                                            <img data-{{$service->main_image!=''?asset('assets/front/img/services/' . $service->main_image):asset('assets/admin/img/noimage.jpg')}}" class="img-fluid lazy" alt="">
                                        </div>
                                    @endif
                                </div>
                                <div class="lawyer_content">
                    ...
                    <div class="pricing_box text-center">
                        <div class="pricing_title">
                            @if (!empty($package->image))
                                <img data-{{$package->image!=''?asset('assets/front/img/packages/' . $package->image):asset('assets/admin/img/noimage.jpg')}}" class="lazy" alt="package icon">
                            @endif
