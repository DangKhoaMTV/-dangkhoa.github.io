...
<li class="mega-dropdown d-none d-lg-inline-block">
    <a class="dropbtn" href="{{ $href }}">{{ $link['text'] }} </a>
                    ...
                    <div class="col-lg-3">
                        <div class="megamenu-cats">
                            <ul>
                                ...
                                @endphp
                                <li><a href="{{ $catUrl }}"
                                        data-tabid="#megaTab{{ $link['type'] }}{{ $mcat->id }}">{{ $mcat->name }}</a>
                                    <ul class="gnb_container">
                                        @foreach ($mItemIds as $mItemId)
                                            @php
                                                $mItem = $itemModel::where('category_id', $mItemId);
                                                if ($mItem->count() == 0) {
                                                    continue;
                                                } else {
                                                    $mItem = $mItem->first();
                                                ...
                                                <div class="single-item">
                                                    <div class="thumb">
                                                        {{-- <a href="{{ $detailsUrl }}" class="d-block">
                                                            <img class="lazy" data-src="{{ $imgSrc }}"
                                                                alt="Megamenu Image" style="width: 100%;">
                                                        </a> --}}
                                                    </div>
                                                    <div class="title">
                                                        <a
                                                            href="{{ $detailsUrl }}">{{ strlen($mItem->title) > 30 ? mb_substr($mItem->title, 0, 30, 'utf-8') . '...' : $mItem->title }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                    ...
                    @foreach ($megaMenus as $mItemId)
                        ...
                        <div class="col">
                            <div class="single-item">
                                <div class="thumb">
                                    <a href="{{ $detailsUrl }}" class="d-block">
                                        <img class="lazy" data-src="{{ $imgSrc }}" alt="Megamenu Image"
                                            style="width: 100%;">
                                    </a>
                                </div>
                                <div class="title">
