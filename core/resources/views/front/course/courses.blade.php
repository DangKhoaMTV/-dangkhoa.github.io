            ...
            <div class="course-item col-lg-4">
              ...
              <div class="course-content">
                ...
                <div class="course-admin-price">
                    <div class="admin">
                      <img src="{{$featured_course->instructor_image!=''?asset('assets/front/img/instructors/' . $featured_course->instructor_image):asset('assets/admin/img/noimage.jpg')}}" class="img-fluid" alt="">
              ...
              <div class="col-md-6 col-sm-12">
                <div class="course-item">
                  ...
                  <div class="course-content">
                    ...
                    <div class="course-admin-price">
                      <div class="admin">
                        <img src="{{$course->instructor_image!=''?asset('assets/front/img/instructors/' . $course->instructor_image):asset('assets/admin/img/noimage.jpg')}}" class="img-fluid" alt="">
