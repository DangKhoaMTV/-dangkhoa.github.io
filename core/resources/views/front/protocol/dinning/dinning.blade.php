                ...
                <div class="col-lg-6 col-sm-12 px-0 col-content">
                    <div class="dinning-right">
                        <div class="dinning-content">
                            ...
                            <a href="#" class="btn-protocol-transparent">{{__('View menu button')}}</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="dinning-item swiper-slide">
                                    ...
                                    <div class="dinning-menu-overlay">
                                        ...
                                        <div class="dinning-view-menu">
                                            <a class="btn-protocol-transparent btn-white" href="{{route('front.dinning_menu',$dinning->slug)}}">{{__('View menu button')}}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
