    ...
    <div class="section-map-home map-about-page section-mt-70 section-mb-70">
        ...
        <script>
            ...
            function initMap() {
                ...
                const protocol = { lat: {{$bex->latitude}}, lng: {{$bex->longitude}} };
        ...
        <div class="google-maps">
            <a target="_blank" href="https://maps.google.com/maps?q=protocol+HOME/@21.2828223,105.7965075,17z/data=!3m1!4b1!4m8!3m7!1s0x3135038b983f2799:0xe3bf7466adaf5b7f!5m2!4m1!1i2!8m2!3d21.2828729!4d105.7986344&hl=vi-VN"><img alt="google maps" src="{{ asset('assets/front/img/bg-home/google-map.svg') }}"></a>
        </div>
    </div>
@endsection
