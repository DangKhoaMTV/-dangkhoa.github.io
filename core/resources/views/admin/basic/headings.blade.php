            ...
            <div class="row">
              <div class="col-lg-8 offset-lg-2">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                    <label>Dinning Title **</label>
                    <input class="form-control" name="dinning_title"
                      value="{{empty(old('dinning_title')) ? $abs->dinning_title : old('dinning_title')}}">
                    @if ($errors->has('dinning_title'))
                    <p class="mb-0 text-danger">{{$errors->first('dinning_title')}}</p>
                    @endif
                  </div>
                  <div class="form-group col-lg-6">
                    <label>Dinning Subtitle **</label>
                    <input class="form-control" name="dinning_subtitle"
                      value="{{empty(old('dinning_subtitle')) ? $abs->dinning_subtitle : old('dinning_subtitle')}}">
                    @if ($errors->has('dinning_subtitle'))
                    <p class="mb-0 text-danger">{{$errors->first('dinning_subtitle')}}</p>
                    @endif
                  </div>

                  <div class="form-group col-lg-6">
                    <label>Dinning Details Title **</label>
                    <input class="form-control" name="dinning_details_title"
                      value="{{empty(old('dinning_details_title')) ? $abs->dinning_details_title : old('dinning_details_title')}}">
                    @if ($errors->has('dinning_details_title'))
                    <p class="mb-0 text-danger">{{$errors->first('dinning_details_title')}}</p>
                    @endif
                  </div>

                  <div class="form-group col-lg-6">
                    <label>Special-offer Title **</label>
                    <input class="form-control" name="special_offer_title"
                      value="{{empty(old('special_offer_title')) ? $abs->special_offer_title : old('special_offer_title')}}">
                    @if ($errors->has('special_offer_title'))
                    <p class="mb-0 text-danger">{{$errors->first('special_offer_title')}}</p>
                    @endif
                  </div>
                  <div class="form-group col-lg-6">
                    <label>Special-offer Subtitle **</label>
                    <input class="form-control" name="special_offer_subtitle"
                      value="{{empty(old('special_offer_subtitle')) ? $abs->special_offer_subtitle : old('special_offer_subtitle')}}">
                    @if ($errors->has('special_offer_subtitle'))
                    <p class="mb-0 text-danger">{{$errors->first('special_offer_subtitle')}}</p>
                    @endif
                  </div>
                  <div class="form-group col-lg-6">
                    <label>Special-offer Details Title **</label>
                    <input class="form-control" name="special_offer_details_title"
                      value="{{empty(old('special_offer_details_title')) ? $abs->special_offer_details_title : old('special_offer_details_title')}}">
                    @if ($errors->has('special_offer_details_title'))
                    <p class="mb-0 text-danger">{{$errors->first('special_offer_details_title')}}</p>
                    @endif
                  </div>
