                    ...
                    <div class="col-lg-6 offset-lg-3">
                        <form id="imageForm" action="{{route('admin.logo.update')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <div class="thumb-preview" id="thumbPreview19">
                                    <img src="{{asset('assets/front/img/' . $abs->admin_logo)}}" alt="Logo">
                                </div>
                                <br>
                                <br>


                                <input id="fileInput19" type="hidden" name="admin_logo">
                                <button id="chooseImage19" class="choose-image btn btn-primary" type="button" data-multiple="false" data-toggle="modal" data-target="#lfmModal19">Choose Image</button>


                                <p class="text-warning mb-0">JPG, PNG, JPEG, SVG images are allowed</p>
                                @if ($errors->has('admin_logo'))
                                <p class="text-danger mb-0">{{$errors->first('admin_logo')}}</p>
                                @endif

                                <!-- Logo LFM Modal -->
                                <div class="modal fade lfm-modal" id="lfmModal19" tabindex="-1" role="dialog" aria-labelledby="lfmModalTitle" aria-hidden="true">
                                    <i class="fas fa-times-circle"></i>
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                <iframe src="{{url('laravel-filemanager')}}?serial=19" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <div class="thumb-preview" id="thumbPreview12">
                                    <img src="{{asset('assets/front/img/' . $abs->mobile_logo)}}" alt="Mobile Logo">
                                </div>
                                <br>
                                <br>


                                <input id="fileInput12" type="hidden" name="mobile_logo">
                                <button id="chooseImage12" class="choose-image btn btn-primary" type="button" data-multiple="false" data-toggle="modal" data-target="#lfmModal12">Choose Image</button>


                                <p class="text-warning mb-0">JPG, PNG, JPEG, SVG images are allowed</p>
                                @if ($errors->has('logo'))
                                <p class="text-danger mb-0">{{$errors->first('mobile_logo')}}</p>
                                @endif

                                <!-- Logo LFM Modal -->
                                <div class="modal fade lfm-modal" id="lfmModal12" tabindex="-1" role="dialog" aria-labelledby="lfmModalTitle" aria-hidden="true">
                                    <i class="fas fa-times-circle"></i>
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                <iframe src="{{url('laravel-filemanager')}}?serial=12" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
