        ...
        <form class="" action="{{route('admin.seo.update', $lang_id)}}" method="post">
          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                    <label>Meta Keywords for Dinning Page</label>
                    <input class="form-control" name="dinning_meta_keywords" value="{{$abe->dinning_meta_keywords}}" placeholder="Enter meta keywords" data-role="tagsinput">
                  </div>
                  <div class="form-group">
                    <label>Meta Description for Dinning Page</label>
                    <textarea class="form-control" name="dinning_meta_description" rows="5" placeholder="Enter meta description">{{$abe->dinning_meta_description}}</textarea>
                  </div>
              </div>

              <div class="col-lg-6">
                <div class="form-group">
                    <label>Meta Keywords for Special-Offers Page</label>
                    <input class="form-control" name="special_offers_meta_keywords" value="{{$abe->special_offers_meta_keywords}}" placeholder="Enter meta keywords" data-role="tagsinput">
                  </div>
                  <div class="form-group">
                    <label>Meta Description for Special-Offers Page</label>
                    <textarea class="form-control" name="special_offers_meta_description" rows="5" placeholder="Enter meta description">{{$abe->special_offers_meta_description}}</textarea>
                  </div>
              </div>
