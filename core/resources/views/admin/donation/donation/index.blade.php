                     ...
                     <table class="table table-striped mt-3" id="basic-datatables">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><img src="{{$donation->image!=''?asset('assets/front/img/donations/' . $donation->image):asset('assets/admin/img/noimage.jpg')}}" alt="" width="80"></td>
                              ...
                              <td>
                                 <a class="btn btn-secondary btn-sm editbtn_url" href="{{route('admin.donation.edit', $donation->id) . '?language=' . request()->input('language')}}" data-url="{{route('admin.donation.edit', $donation->id) . '?language=' . request()->input('language'). ' #edit_content'}}" data-toggle="modal" data-target="#editModal">
                    ...
                    <div class="tab-content">
                        @foreach ($langs as $lang)
                           ...
                           <div class="form-group">
                              ...
                              <input type="number" class="form-control ltr" name="goal_amount_{{$lang->code}}" value="" placeholder="Enter Amount" required>
                              <p id="errgoal_amount_{{$lang->code}}" class="mb-0 text-danger em"></p>
                           </div>
                            <div class="form-group">
                                <label for="">Minimum Amount (in {{$abx->base_currency_text}}) **</label>
                                <input type="number" class="form-control ltr" name="min_amount_{{$lang->code}}" value="" placeholder="Enter Amount" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="custom_amount_{{$lang->code}}" value="" data-role="tagsinput">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"         aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" >
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle" >Edit Donation</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade lfm-modal" id="lfmModal{{$lang->id}}1" tabindex="-1" role="dialog" aria-labelledby="lfmModalTitle" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body p-0">
                <iframe src="{{url('laravel-filemanager')}}?serial={{$lang->id}}1" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
            </div>
        </div>
    </div>
</div>
