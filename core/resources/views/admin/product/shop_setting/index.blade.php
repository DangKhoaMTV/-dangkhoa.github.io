...
@section('content')
                    ...
                    <tbody>
                      @foreach ($shippings as $key => $shipping)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm editbtn_url" href="{{route('admin.shipping.edit', $shipping->id) . '?language=' . request()->input('language')}}" data-url="{{route('admin.shipping.edit', $shipping->id) . '?language=' . request()->input('language') . ' #edit_content'}}" data-toggle="modal" data-target="#editModal">
                  ...
                  <div class="tab-content">
                      @foreach ($langs as $lang)
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control ltr" name="charge_{{$lang->code}}" value="" placeholder="Enter charge">
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">Edit Shipping Charge</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
