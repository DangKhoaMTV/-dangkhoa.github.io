...
@section('content')
                    ...
                    <tbody>
                        @foreach ($coupons as $coupon)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.coupon.edit', $coupon->id)}}" data-url="{{route('admin.coupon.edit', $coupon->id) . ' #edit_content'}}" class="btn btn-warning btn-sm editbtn_url" data-toggle="modal" data-target="#editModal">Edit</a>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">Edit Coupons</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
