                    ...
                    <tbody>
                      @foreach ($jcategorys as $key => $jcategory)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm editbtn_url" data-url="{{route('admin.jcategory.edit', $jcategory->id) . '?language=' . request()->input('language')}}" href="#editModal" data-toggle="modal" data-jcategory_id="{{$jcategory->id}}" data-name="{{$jcategory->name}}" data-status="{{$jcategory->status}}" data-serial_number="{{$jcategory->serial_number}}">
