...
@elseif(request()->routeIs('admin.product.attribute')) active
...
@elseif(request()->routeIs('admin.product.attribute')) show
...
<li class="submenu">
    ...
    aria-expanded="{{(request()->path() == 'admin/category' || request()->is('admin/category/*/edit') || request()->routeIs('admin.product.attribute') || request()->routeIs('admin.product.type') || request()->routeIs('admin.product.create') || request()->routeIs('admin.product.index') || request()->routeIs('admin.product.edit')) ? 'true' : 'false' }}">
...
<li class="
@if(request()->routeIs('admin.product.attribute')) active
@endif">
<a href="{{route('admin.product.attribute'). '?language=' . $default->code}}">
