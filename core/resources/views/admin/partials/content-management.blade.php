...
@elseif(request()->is('admin/approach/*/pointedit')) active
@elseif(request()->path() == 'admin/special_offers') active
...
@elseif(request()->routeIs('admin.service.attribute')) active
...
@endif">
    ...
    @elseif(request()->is('admin/approach/*/pointedit')) show
    @elseif(request()->path() == 'admin/special_offers') show
    ...
    @elseif(request()->routeIs('admin.service.attribute')) show
    ...
    @elseif(request()->is('admin/dinning/settings')) show
    @elseif(request()->path() == 'admin/dinnings') show
    ...
    @endif" id="webContents">
        <ul class="nav nav-collapse">
            ...
            @elseif(request()->is('admin/approach/*/pointedit')) selected
            @elseif(request()->path() == 'admin/special_offers') selected
            ...
            @endif">
                ...
                @endif" id="home">
                    ...
                    @if ($bex->home_page_pagebuilder == 0)
                    <li class="@if(request()->path() == 'admin/special_offer') active @endif">
                        <a href="{{route('admin.special_offer.index') . '?language=' . $default->code}}">
                            <span class="sub-item">Special Offer</span>
                        </a>
                    </li>
                    @endif
            ...
            @elseif(request()->routeIs('admin.service.attribute')) selected
            @endif">
                ...
                @endif" id="service">
                    <ul class="nav nav-collapse subnav">
                        ...
                        <li class="
@if(request()->routeIs('admin.service.attribute')) active
@endif">
                            <a href="{{route('admin.service.attribute'). '?language=' . $default->code}}">
                                <span class="sub-item"> Attribute </span>
                            </a>
                        </li>
            ...
            {{-- Dinning Management --}}
            <li class="
            @if(request()->is('admin/dinning/settings')) selected
            @elseif(request()->path() == 'admin/dinnings') selected
            @elseif(request()->is('admin/dinning/*/edit')) selected
            @endif">
                <a data-toggle="collapse" href="#dinning">
                    <span class="sub-item">Dinnings</span>
                    <span class="caret"></span>
                </a>
                <div class="collapse
                @if(request()->path() == 'admin/scategorys') show
                ...
                @elseif(request()->is('admin/scategory/*/edit')) show
                @elseif(request()->path() == 'admin/dinnings') show
                @elseif(request()->is('admin/dinning/*/edit')) show
                @endif" id="dinning">
                    <ul class="nav nav-collapse subnav">
                        <li class="
                            @if(request()->path() == 'admin/dinning/settings') active
                            @endif">
                            <a href="{{route('admin.dinning.settings'). '?language=' . $default->code}}">
                                <span class="sub-item">Settings</span>
                            </a>
                        </li>
                        <li class="
                        @if(request()->path() == 'admin/dinnings') active
                        @elseif(request()->is('admin/dinning/*/edit')) active
                        @endif">
                            <a href="{{route('admin.dinning.index') . '?language=' . $default->code}}">
                                <span class="sub-item">Dinning</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            @endif">
                ...
                @endif" id="career">
                    <ul class="nav nav-collapse subnav">
                        ...
                        @endif">
                            <a href="{{route('admin.job.create'). '?language=' . $default->code}}">
