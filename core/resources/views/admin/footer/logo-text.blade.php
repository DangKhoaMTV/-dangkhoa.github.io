                  ...
                  <div class="tab-content">
                      ...
                      <div class="tab-pane container {{$lang->code == request()->input('language') ? 'active' : ''}}" id="upload-lang-{{$lang->code}}">
                          ...
                          <div class="form-group">
                              ...
                              <div class="thumb-preview" id="thumbPreview1{{$lang->id}}">
                                  <label for="chooseImage1{{$lang->id}}">
                                      <img src="{{asset('assets/front/img/'.$abs[$lang->code]->footer_logo)}}" alt="Footer Logo">
                                  </label>
                              </div>
                              <br>
                              <br>

                              <input id="fileInput1{{$lang->id}}" type="hidden" name="footer_logo_{{$lang->code}}">
                              <button id="chooseImage1{{$lang->id}}"
                                      class="choose-image btn btn-primary"
                                      type="button"
                                      data-multiple="false"
                                      data-toggle="modal"
                                      data-target="#lfmModal1{{$lang->id}}">
                                  Choose Image
                              </button>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="footer_text_{{$lang->code}}" value="{{$abs[$lang->code]->footer_text}}">
                              <p id="errfooter_text" class="em text-danger mb-0"></p>
                          </div>
                          <div class="form-group">
                              <label for="">Newsletter Text **</label>
                              <input type="text" class="form-control" name="newsletter_text_{{$lang->code}}" value="{{$abs[$lang->code]->newsletter_text}}">
                              <p id="errnewsletter_text" class="em text-danger mb-0"></p>
                          </div>
                          <div class="form-group">
                              <label for="">Copyright Text **</label>
                              <textarea id="copyright_text" name="copyright_text_{{$lang->code}}" class="summernote form-control" data-height="150">{{convertHtml($abs[$lang->code]->copyright_text)}}</textarea>
