                    ...
                    <tbody>
                      @foreach ($event_categories as $key => $event_category)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm editbtn_url" href="#editModal" data-toggle="modal" data-url="{{route('admin.event.category.edit', $event_category->id). '?language=' . request()->input('language')}}" data-bcategory_id="{{$event_category->id}}" data-name="{{$event_category->name}}" data-status="{{$event_category->status}}">
