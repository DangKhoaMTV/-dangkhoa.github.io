                     ...
                     <table class="table table-striped mt-3" id="basic-datatables">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <a class="btn btn-secondary btn-sm editbtn_url" href="{{route('admin.event.edit', $event->id) . '?language=' . request()->input('language')}}" data-url="{{route('admin.event.edit_modal', $event->id) . '?language=' . request()->input('language')}}" data-toggle="modal" data-target="#editModal">
                    ...
                    <div class="tab-content">
                        @foreach ($langs as $lang)
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <div class="video-preview" id="videoPreview2{{$lang->id}}">
                                    <video width="320" height="240" controls id="video_src_{{$lang->code}}">
                                ...
                                <input id="fileInput2{{$lang->id}}" type="hidden" name="video_{{$lang->code}}">
                                <button id="chooseVideo2{{$lang->id}}" class="choose-video btn btn-primary" type="button" data-multiple="false" data-video="true" data-toggle="modal" data-target="#lfmModal2{{$lang->id}}">Choose Video</button>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <div class="slider-thumbs" id="sliderThumbs1{{$lang->id}}">

                                        </div>

                                        <input id="fileInput1{{$lang->id}}" type="hidden" name="slider_{{$lang->code}}" value="" />
                                        <button id="chooseImage1{{$lang->id}}" class="choose-image btn btn-primary" type="button" data-multiple="true" data-toggle="modal" data-target="#lfmModal1{{$lang->id}}">Choose Images</button>
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="title_{{$lang->code}}" placeholder="Enter title" value="" required>
                              <p id="errtitle_{{$lang->code}}" class="mb-0 text-danger em"></p>
                           </div>
                           <div class="form-group">
                              <label for="">Category **</label>
                              <select id="bcategory" class="form-control" name="cat_id_{{$lang->code}}" required>
                                 <option value="" selected disabled>Select a category</option>
                                  @foreach ($event_categories[$lang->code] as $event_category)
                           ...
                           <div class="form-group">
                              ...
                              <textarea class="form-control summernote" name="content_{{$lang->code}}" rows="8" cols="80" placeholder="Enter content"></textarea>
                              <p id="errcontent_{{$lang->code}}" class="mb-0 text-danger em"></p>
                           </div>
                            <div class="form-group">
                                <label for="">Date **</label>
                                <input type="date" class="form-control ltr" name="date_{{$lang->code}}" value="" placeholder="Enter Event Date" required>
                                <p id="errdate_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Time **</label>
                                <input type="time" class="form-control ltr" name="time_{{$lang->code}}" value="" placeholder="Enter Event Time" required>
                                <p id="errtime_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                           <div class="form-group">
                              <label for="">Cost (in {{$abx->base_currency_text}}) **</label>
                              <input type="number" class="form-control ltr" name="cost_{{$lang->code}}" value="" placeholder="Enter Ticket Cost" required>
                              <p id="errcost_{{$lang->code}}" class="mb-0 text-danger em"></p>
                           </div>
                            <div class="form-group">
                                <label for="">Available Tickets **</label>
                                <input type="number" class="form-control ltr" name="available_tickets_{{$lang->code}}" value="" placeholder="Enter Available Tickets Number" required>
                                <p id="erravailable_tickets_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Organizer **</label>
                                <input type="text" class="form-control ltr" name="organizer_{{$lang->code}}" value="" placeholder="Event Organizer" required>
                                <p id="errorganizer_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Organizer Email</label>
                                <input type="text" class="form-control ltr" name="organizer_email_{{$lang->code}}" value="" placeholder="Organizer Email">
                                <p id="errorganizer_email_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Organizer Phone</label>
                                <input type="text" class="form-control ltr" name="organizer_phone_{{$lang->code}}" value="" placeholder="Organizer Phone">
                                <p id="errorganizer_phone_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Organizer Website</label>
                                <input type="text" class="form-control ltr" name="organizer_website_{{$lang->code}}" value="" placeholder="Organizer Website">
                                <p id="errorganizer_website_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Venue **</label>
                                <input type="text" class="form-control ltr" name="venue_{{$lang->code}}" value="" placeholder="Enter Venue" required>
                                <p id="errvenue_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Venue Location</label>
                                <input type="text" class="form-control ltr" name="venue_location_{{$lang->code}}" value="" placeholder="Venue Location">
                                <p id="errvenue_location_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                            <div class="form-group">
                                <label for="">Venue Phone</label>
                                <input type="text" class="form-control ltr" name="venue_phone_{{$lang->code}}" value="" placeholder="Venue Phone">
                                <p id="errvenue_phone_{{$lang->code}}" class="mb-0 text-danger em"></p>
                            </div>
                           <div class="form-group">
                              <label for="">Meta Keywords</label>
                              <input type="text" class="form-control" name="meta_tags_{{$lang->code}}" value="" data-role="tagsinput">
                           </div>
                           <div class="form-group">
...
@foreach ($langs as $lang)
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body p-0">
                    <iframe id="lfmIframe1{{$lang->id}}" src="{{url('laravel-filemanager')}}?serial=1{{$lang->id}}" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
                </div>
            </div>
        </div>
    </div>
   ...
   <!-- slider LFM Modal -->
    <div class="modal fade lfm-modal" id="lfmModal{{$lang->id}}1" tabindex="-1" role="dialog" aria-labelledby="lfmModalTitle" aria-hidden="true">
        <i class="fas fa-times-circle"></i>
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body p-0">
                    <iframe id="lfmIframe{{$lang->id}}1" src="{{url('laravel-filemanager')}}?serial={{$lang->id}}1" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Video LFM Modal -->
    <div class="modal fade lfm-modal" id="lfmModal{{$lang->id}}2" tabindex="-1" role="dialog" aria-labelledby="lfmModalTitle" aria-hidden="true">
        <i class="fas fa-times-circle"></i>
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body p-0">
                    <iframe src="{{url('laravel-filemanager')}}?serial={{$lang->id}}2" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
                </div>
            </div>
        </div>
    </div>
