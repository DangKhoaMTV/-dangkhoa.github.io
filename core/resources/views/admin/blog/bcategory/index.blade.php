                    ...
                    <tbody>
                      @foreach ($bcategorys as $key => $bcategory)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm editbtn_url" href="#editModal" data-url="{{route('admin.bcategory.edit', $bcategory->id) . '?language=' . request()->input('language')}}" data-toggle="modal" data-bcategory_id="{{$bcategory->id}}" data-name="{{$bcategory->name}}" data-status="{{$bcategory->status}}" data-serial_number="{{$bcategory->serial_number}}">
