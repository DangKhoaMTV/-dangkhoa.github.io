...
@section('content')
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title d-inline-block">Package Categories</div>
            </div>
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{ route('admin.package.bulk_delete_category') }}">
          ...
          <div class="row">
            <div class="col-lg-12">
              @if (count($categories) == 0)
                <h3 class="text-center">NO PACKAGE CATEGORY FOUND!</h3>
              @else
                    ...
                    <tbody>
                      @foreach ($categories as $category)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1 editbtn_url" href="#" data-toggle="modal" data-target="#editModal" data-url="{{route('admin.package.edit_category', $category->id) . '?language=' . request()->input('language')}}" data-id="{{ $category->id }}" data-name="{{ $category->name }}" data-status="{{ $category->status }}" data-serial_number="{{ $category->serial_number }}">
                            ...
                            <form class="deleteform d-inline-block" action="{{ route('admin.package.delete_category') }}" method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.package.create_category')
