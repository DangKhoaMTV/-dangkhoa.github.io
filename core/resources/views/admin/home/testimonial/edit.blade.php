            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.testimonial.update')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="thumb-preview" id="thumbPreview1">
                        <img src="{{$testimonial->image!=''?asset('assets/front/img/testimonials/' . $testimonial->image):asset('assets/admin/img/noimage.jpg')}}" alt="Client">
                    </div>
                    <br>
                    <br>
                ...
                <div class="form-group">
                  ...
                  <input type="number" min="0" max="5" class="form-control" name="rank" value="{{$testimonial->rank}}" placeholder="Enter rank">
              ...
              <div class="form-group">
                  ...
                  <select class="form-control select2" name="channel_{{$lang->code}}">
                      ...
                      <option value="google" {{$testimonial->channel == 'google'?'selected':''}}>Google</option>
                      <option value="facebook" {{$testimonial->channel == 'facebook'?'selected':''}}>Facebook</option>
                      <option value="twitter" {{$testimonial->channel == 'twitter'?'selected':''}}>Twitter</option>
                  </select>
