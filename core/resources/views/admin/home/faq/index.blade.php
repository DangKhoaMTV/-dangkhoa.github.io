              ...
              <table class="table table-striped mt-3" id="basic-datatables">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-secondary btn-sm editbtn_url" href="#editModal" data-url="{{route('admin.faq.edit', $faq->id) . '?language=' . request()->input('language')}}" data-toggle="modal"
                    ...
                    @foreach ($langs as $lang)
                        <div class="tab-pane container {{$lang->code == request()->input('language') ? 'active' : ''}}"
                            ...
                            <div class="form-group {{ $categoryInfo->faq_category_status == 0 ? 'd-none' : '' }}">
                                ...
                                <select name="category_id_{{$lang->code}}" id="faq_category_id" class="form-control">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="question_{{$lang->code}}" value="" placeholder="Enter question">
                                <p id="errquestion_{{$lang->code}}" class="mb-0 text-danger em"></p>
                              </div>
                              <div class="form-group">
                                <label for="">Answer **</label>
                                <textarea class="form-control" name="answer_{{$lang->code}}" rows="5" cols="80" placeholder="Enter answer"></textarea>
                                <p id="erranswer_{{$lang->code}}" class="mb-0 text-danger em"></p>
                              </div>
                              <div class="form-group">
