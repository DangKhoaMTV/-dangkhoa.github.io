                    ...
                    <tbody>
                      @foreach ($categories as $category)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1 editbtn_url" href="#" data-url="{{route('admin.faq.edit_category', $category->id) . '?language=' . request()->input('language')}}" data-toggle="modal" data-target="#editModal" data-id="{{ $category->id }}" data-name="{{ $category->name }}" data-status="{{ $category->status }}" data-serial_number="{{ $category->serial_number }}">
