    ...
    <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($langs))
                        ...
                        @if ($be->theme_version == 'default' || $be->theme_version == 'dark')
                            ...
                            <div class="form-group">
                                ...
                                <div class="thumb-preview" id="thumbPreview{{$lang->id}}">
                                    <label for="chooseImage{{$lang->id}}"><img src="{{asset('assets/front/img/'.$abs[$lang->code]->team_bg)}}" alt="Background"></label>
                                </div>
                                <br>
                                <br>


                                <input id="fileInput{{$lang->id}}" type="hidden" name="background_{{$lang->code}}">
                        ...
                        @endif
                            ...
                            <div class="form-group">
                                <label>Title **</label>
                                <input class="form-control" name="team_section_title_{{$lang->code}}" value="{{$abs[$lang->code]->team_section_title}}" placeholder="Enter Title">
                                @if ($errors->has('team_section_title_'.$lang->code))
                                <p class="mb-0 text-danger">{{$errors->first('team_section_title_'.$lang->code)}}</p>
                                @endif
                            </div>
                            <div class="form-group">
                                <label>Subtitle **</label>
                                <input class="form-control" name="team_section_subtitle_{{$lang->code}}" value="{{$abs[$lang->code]->team_section_subtitle}}" placeholder="Enter Subtitle">
                                @if ($errors->has('team_section_subtitle_'.$lang->code))
                                <p class="mb-0 text-danger">{{$errors->first('team_section_subtitle_'.$lang->code)}}</p>
                                @endif
                            </div>
                                </div>
                            @endforeach
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('admin.member.create') . '?language=' . request()->input('language')}}" class="btn btn-primary float-right"  data-toggle="modal" data-target="#createMemberModal"><i class="fas fa-plus"></i> Add Member</a>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <table class="table table-striped mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{$member->image!=''?asset('assets/front/img/members/' . $member->image):asset('assets/admin/img/noimage.jpg')}}" alt="" width="40"></td>
                                        ...
                                        <td>
                                            <a class="btn btn-secondary btn-sm editbtn_url" data-url="{{route('admin.member.edit-modal', $member->id) . '?language=' . request()->input('language')}}" href="{{route('admin.member.edit', $member->id) . '?language=' . request()->input('language')}}" data-toggle="modal" data-target="#editModal">
...
@includeif('admin.home.member.create-modal')
@endsection
