            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.portfoliosection.update', $lang_id)}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input name="portfolio_section_title_{{$lang->code}}" class="form-control" value="{{$abs[$lang->code]->portfolio_section_title}}">
                  <p id="errportfolio_section_title_{{$lang->code}}" class="em text-danger mb-0"></p>
                </div>
                <div class="form-group">
                  <label for="">Text **</label>
                  <input name="portfolio_section_text_{{$lang->code}}" class="form-control" value="{{$abs[$lang->code]->portfolio_section_text}}">
                  <p id="errportfolio_section_text_{{$lang->code}}" class="em text-danger mb-0"></p>
                </div>
                              </div>
                          @endforeach
                      </div>
