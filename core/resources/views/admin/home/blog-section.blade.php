            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.blogsection.update', $lang_id)}}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input name="blog_section_title_{{$lang->code}}" class="form-control" value="{{$abs[$lang->code]->blog_section_title}}">
                  <p id="errblog_section_title_{{$lang->code}}" class="em text-danger mb-0"></p>
                </div>
                <div class="form-group">
                  <label for="">Text **</label>
                  <input name="blog_section_subtitle_{{$lang->code}}" class="form-control" value="{{$abs[$lang->code]->blog_section_subtitle}}">
                  <p id="errblog_section_subtitle_{{$lang->code}}" class="em text-danger mb-0"></p>
                </div>
                          </div>
                  @endforeach
                  </div>
