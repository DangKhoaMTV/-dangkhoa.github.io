                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            @if ($be->theme_version != "ecommerce")
                                <div class="form-group">
                                    <label>Special Offer Section **</label>
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="special_offer_section" value="1" class="selectgroup-input" {{$abs->special_offer_section == 1 ? 'checked' : ''}}>
                                            <span class="selectgroup-button">Active</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="special_offer_section" value="0" class="selectgroup-input" {{$abs->intro_section == 0 ? 'checked' : ''}}>
                                            <span class="selectgroup-button">Deactive</span>
                                        </label>
                                    </div>
                                </div>
