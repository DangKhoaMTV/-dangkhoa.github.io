                    ...
                    <tbody>
                      @foreach ($categories as $category)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1 editbtn_url" data-url="{{route('admin.gallery.edit_category_modal', $category->id) . '?language=' . request()->input('language')}}" href="#" data-toggle="modal" data-target="#editModal" data-id="{{ $category->id }}" data-name="{{ $category->name }}" data-status="{{ $category->status }}" data-serial_number="{{ $category->serial_number }}">
