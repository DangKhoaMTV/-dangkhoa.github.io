                        ...
                        <div class="card border-primary mb-3">
                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">{{__('Dinning')}}
                                        <span class="badge badge-dark">Non Mega Menu</span>
                                        <a data-text="{{__('Dinning')}}" data-type="dinning" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a>
                                    </li>
                                    ...
                                    <li class="list-group-item">{{__('Special Offer')}} <a data-text="{{__('Special Offer')}}" data-type="special_offers" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
