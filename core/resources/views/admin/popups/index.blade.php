                          ...
                          <td>
                              <div class="mb-2">
                                  @if (!empty($popup->image))
                                      <img src="{{$popup->image!=''?asset('assets/front/img/popups/' . $popup->image):asset('assets/admin/img/noimage.jpg')}}" width="65">
                                  @elseif (!empty($popup->background_image))
                                    <img src="{{$popup->background_image!=''?asset('assets/front/img/popups/' . $popup->background_image):asset('assets/admin/img/noimage.jpg')}}" width="65">
                                  @endif
                              </div>
                          </td>
