                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="{{$scategory->image!=''?asset('assets/front/img/service_category_icons/' . $scategory->image):asset('assets/admin/img/noimage.jpg')}}" width="40">
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-secondary btn-sm editbtn_url" data-url="{{route('admin.scategory.edit-modal', $scategory->id) . '?language=' . request()->input('language')}}" href="{{route('admin.scategory.edit', $scategory->id) . '?language=' . request()->input('language')}}" data-toggle="modal" data-target="#editModal">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.scategory.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="thumb-preview" id="thumbPreview{{$lang->id}}">
                        <label for="chooseImage{{$lang->id}}"><img src="{{asset('assets/admin/img/noimage.jpg')}}" alt="Icon Image"></label>
                    </div>
                    <br>
                    <br>
                    ...
                    <input type="hidden" name="language_id_{{$lang->code}}" value="{{$lang->id}}">
